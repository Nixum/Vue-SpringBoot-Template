...
public class JedisUtil {
     ...
     * 操作Key的方法
     */
    public RedisKey keyProcessor;
    /**
     * 对存储结构为String类型的操作
     */
    public RedisString StringProcessor;
    /**
     * 对存储结构为List类型的操作
     */
    public RedisList ListProcessor;
    /**
     * 对存储结构为Set类型的操作
     */
    public RedisSet SetProcessor;
    /**
     * 对存储结构为HashMap类型的操作
     */
    public RedisHash HashProcessor;
    /**
     * 对存储结构为Set(排序的)类型的操作
     */
    public RedisSortSet SortSetProcessor;

    private JedisUtil() {
        keyProcessor = new RedisKey();
        StringProcessor = new RedisString();
        ListProcessor = new RedisList();
        SetProcessor = new RedisSet();
        HashProcessor = new RedisHash();
        SortSetProcessor = new RedisSortSet();
    }
